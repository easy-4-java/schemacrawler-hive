...
[![Java](https://img.shields.io/badge/Java-8-orange)](https://github.com/easy-4-java/schemacrawler-hive) [![License](https://img.shields.io/badge/license-Apache%202.0-green)](./LICENSE)

schemacrawler-hive is a SchemaCrawler database plug-in that registers
...
```groovy
implementation 'io.github.easy4j:schemacrawler-hive:1.0.x.20260630-SNAPSHOT'
```
